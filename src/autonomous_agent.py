...
from .token_operations import get_erc20_balance_behaviour, transfer_erc20_token 
...
class AutonomousAgent(Agent):
    ...
    def __init__(self,agent_name):
        ...
        self.register_handler("hello", self.hello_filter_handler)
    ...
    def start(self):
        ...
        # Register behaviors
        self.register_behaviour(self.random_word_gen_behaviour)
        self.register_behaviour(self.get_erc20_balance_behaviour)
